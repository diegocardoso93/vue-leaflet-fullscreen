 ...
 * leaflet.fullscreen
 */
export function loadLeafletFullScreen(leaflet, screenfull) {
  "use strict";
  ...
  leaflet.Control.FullScreen = leaflet.Control.extend({
    ...
    _toggleState: function () {
      ...
      this._map._isFullscreen
        ? leaflet.DomUtil.removeClass(this.link, "leaflet-fullscreen-on")
        : leaflet.DomUtil.addClass(this.link, "leaflet-fullscreen-on");
    },
 ...
 */
export function loadScreenfull() {
  "use strict";
